...
Este documento describe la estructura y los supuestos clave de proyección (drivers) del modelo financiero de tres estados para The Kraft Heinz Company (KHC). Este modelo fue desarrollado en Excel utilizando como fuente única de datos históricos el informe presentado ante la SEC, [Annual Report Form 10-K 2025](KHC_Annual_Report_10K_2025.pdf), para el periodo 2023A-2025A. Su propósito es proyectar los estados financieros de la empresa a cinco años (2026E-2030E), cumpliendo con los estándares de FP&A y asegurando un cuadre dinámico del balance.
...
* **Retained Earnings:** El saldo proyectado en el roll-forward alimenta directamente las ganancias retenidas en el Balance Sheet. Los dividendos declarados de acciones ordinarias proceden de los históricos proporcionados por la empresa en el estado consolidado del patrimonio (p. 54 del 10-K). Para su proyección, dado que la utilidad neta anual estimada supera el dividendo del ejercicio, se asume el cargo total dentro del roll-forward de utilidades retenidas, reduciendo progresivamente el déficit acumulado sin proyectar nuevos cargos por retorno de capital (APIC) como el registrado en 2025A.
