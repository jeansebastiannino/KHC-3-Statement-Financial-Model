...
* **Retained Earnings:** The projected balance in the roll-forward directly feeds the retained earnings on the Balance Sheet. Declared common stock dividends come from the historicals provided by the company in the consolidated statement of equity (p. 54 of the 10-K). For their projection, since estimated annual net income exceeds the period's dividend, the full charge is assumed within the retained earnings roll-forward, progressively reducing the accumulated deficit without projecting further return of capital charges (APIC) as recorded in 2025A.
